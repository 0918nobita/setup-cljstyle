...
const url2 = `http://github.com/greglook/cljstyle/releases/download/${version}/${tarFile}`;
async function run() {
  const res = await lib_default(url2);
  ...
  const execCmd = util.promisify(child_process.exec);
