...
var require_retry_helper = __commonJS((exports) => {
  ...
  Object.defineProperty(exports, "__esModule", {value: true});
  const core2 = __importStar(require_core());
  class RetryHelper {
...
var require_tool_cache = __commonJS((exports) => {
  ...
  function downloadTool2(url2, dest, auth) {
    return __awaiter(this, void 0, void 0, function* () {
      ...
      return yield retryHelper.execute(() => __awaiter(this, void 0, void 0, function* () {
        return yield downloadToolAttempt(url2, dest || "", auth);
      }), (err) => {
  ...
  function downloadToolAttempt(url2, dest, auth) {
    return __awaiter(this, void 0, void 0, function* () {
...
const absolute = (path3) => path3;
const relative = (path3) => path3;
const joinPath = (base, relativePath) => path.join(base, relativePath);
...
(async () => {
  ...
  const extractedDir = await tc.extractTar(tarPath, joinPath(binDir, relative("cljstyle")));
